...
numberButtons[1].setBackground(Color.green);
panel.add(numberButtons[2]); 
numberButtons[2].setBackground(Color.green);
panel.add(numberButtons[3]);
numberButtons[3].setBackground(Color.green);
panel.add(addButton);
panel.add(numberButtons[4]); 
numberButtons[4].setBackground(Color.red);
panel.add(numberButtons[5]);
numberButtons[5].setBackground(Color.red);
panel.add(numberButtons[6]);
numberButtons[6].setBackground(Color.red);
panel.add(subButton);
panel.add(numberButtons[7]); 
numberButtons[7].setBackground(Color.yellow);
panel.add(numberButtons[8]);
numberButtons[8].setBackground(Color.yellow);
panel.add(numberButtons[9]);
numberButtons[9].setBackground(Color.yellow);
panel.add(mulButton); 
panel.add(decButton);
